...
import { Header, HeaderTexts, HeaderTextName, Container,
  UltimoJogo, JogoTitulo, JogoContent, JogoTimes, JogoInfo, TimeName,
  JogoDetalhes, JogoDetalhesTitle, JogoDetalhesView, JogoInfoTime, JogoInfoData,
  JogoLogo } from './styles';
...
export default function Jogos({ navigation }) {
  ...
  return (
    ...
    <UltimoJogo style={{
          ...
          <JogoDetalhesView>
          <JogoDetalhes underlayColor="#f3f3f3" onPress={() => navigation.navigate('JogosSingle')}>
